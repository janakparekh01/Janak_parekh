                        ...
                        <div class="panel-body">
                           ...
                           foreach($book_arr as $data)
                          {
                                        ...
                                        <tr class="odd gradeX">
                                            ...
                                            <?php if(!isset($_GET['action'])) { ?>
                                            <td>
                                                <?php if(isset($_GET['delete_book']) && $_GET['delete_book'] != '') { ?>
                                                    <a href="delete?del_book_id=<?php echo $data->id;?>"class="btn btn-danger">Delete</a>
                                                <?php }
                                                    else if(isset($_GET['edit_book']) && $_GET['edit_book'] != '') { ?>
                                                    <a href="edit?edit_book_id=<?php echo $data->id;?>"class="btn btn-primary">Edit</a>
                                                <?php } ?>
                                            </td>
                                            <?php } ?>
                                        </tr>
